...
const DiagnosticDashBoard = () => {
  ...
  return (
    <div>
      <NavBar_Logout />
      <div className="bg-gradient-to-b from-black to-green-700 p-4 sm:p-10 font-mono text-black h-screen flex flex-col justify-center items-center">
        ...
        <div className="space-y-4 space-x-4">
          <button
            ...
            className="px-6 py-3 bg-teal-500 hover-bg-gray-600 text-black rounded-lg focus:outline-none focus:ring focus:ring-teal-400 transition duration-300"
          >
            View Profile
          </button>
          <button
