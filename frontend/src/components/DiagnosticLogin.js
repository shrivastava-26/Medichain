...
const DiagnosticLogin = () => {
  ...
  return (
    <div>
      <NavBar />
      <div className="bg-gradient-to-b from-black to-green-700 min-h-screen flex flex-col justify-center items-center p-4 font-mono text-black">
        <div className="w-full max-w-4xl bg-green-900 p-20 rounded-lg shadow-lg">
          ...
          <div className="flex flex-col w-full mb-4">
            ...
            <input
              ...
              className="p-2 w-full text-black bg-gray-700 border border-gray-600 rounded-md hover:bg-gray-800 transition duration-200"
              required
            />
          </div>
          ...
          <button
            ...
            className="px-6 py-3 bg-teal-500 text-black font-bold text-lg rounded-lg cursor-pointer transition-transform transition-colors duration-300 ease-in hover:bg-teal-600 active:bg-teal-700"
          >
            Login
            </button>
            <button
