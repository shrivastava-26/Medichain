...
const DoctorRegistry = () => {
  ...
  return (
    <div>
    <NavBar></NavBar>
    <div className="createehr min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-black to-green-700 font-mono">
      <div className="w-full max-w-2xl">
        <h2 className="text-3xl text-white mb-6 font-bold text-center">
          Doctor Registration
        </h2>
        <form className="bg-green-900 p-6 rounded-lg shadow-lg grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="mb-4">
            <label
          ...
          <div className="mb-4">
            <label className="block font-bold text-black" htmlFor="doctorName">
              Full Name
            </label>
            <input
              id="doctorName"
        ...
        <div className="space-x-4 text-center mt-6">
          <button
            ...
            className="py-3 px-4 bg-teal-500 text-black rounded-md font-medium hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
          >
            Register 
            </button>
            <button
