...
const ViewDiagnosticProfile = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-b from-black to-green-700 p-4 sm:p-10 font-mono text-black flex flex-col justify-center items-center">
        <div className="h-full max-w-8xl bg-gray-700 p-24 rounded-lg shadow-lg flex flex-col justify-center items-center">
          ...
          <div className="col-span-full">
            <button
              ...
              className="px-5 py-2.5 bg-custom-teal text-black font-bold text-lg rounded-lg cursor-pointer mt-3 mr-5 transition-transform transition-background-color duration-300 ease-in hover:bg-gray-400 transform hover:scale-105"
            >
              Close
            </button>
          </div>
